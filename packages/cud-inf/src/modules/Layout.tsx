  ...
  const getButtonStyles = (path: string) => {
    return buttonVariants({
      ...
      className: `rounded-lg w-full h-full p-2 my-1 ${
        isCurrentRoute(path) ? 'bg-black text-white hover:bg-black/90' : ''
      }`,
    });
  };
          ...
          <nav className='grid gap-2 p-2'>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link to='/demo' className={getButtonStyles('/')} aria-label='Home'>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link to='/demo/details' className={getButtonStyles('/details')} aria-label='Details'>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link to='/demo/referral' className={getButtonStyles('/referral')} aria-label='Referral'>
