      ...
      <CardContent>
        <Tabs defaultValue='timeline'>
          <TabsList className='mt-2 mb-2 py-2 cursor-pointer'>
            <TabsTrigger value='timeline'>{intl.formatMessage({ id: 'details.course_timeline.timeline' })}</TabsTrigger>
            <TabsTrigger value='calendar'>{intl.formatMessage({ id: 'details.course_timeline.calendar' })}</TabsTrigger>
          </TabsList>
